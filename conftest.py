...
def create_log_file(request, ini):
    current_time_formatted = datetime.datetime.now().strftime(get_configuration_value("start_time_format"))
    ...
    formatter = logging.Formatter(get_configuration_value("logging_format")
                                  , datefmt=get_configuration_value("date_format"))
    ...
    file_logger = logging.getLogger(get_configuration_value("default_log_name"))
    ...
    log_levels.get("", )
    file_logger.setLevel(log_levels[get_configuration_value("log_level").upper()])
